...
function ModalAddAttachmentsComponent_ng_container_15_Template(rf, ctx) {
    if (rf & 1) {
...
function DesktopFullScreenComponent_ng_container_3_div_2_ng_container_8_ng_container_3_ng_container_4_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);

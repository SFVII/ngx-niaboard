...
import { NgxAttachmentService, NgxAttachmentModule } from '@nowbrains/ngx-attachment';
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(KonversoService, [{
        ...
        return [{ type: undefined, decorators: [{
                    ...
                    }] }, { type: i1.HttpClient }, { type: i2.NgxAttachmentService }];
    }, null);
})();
...
class ModalAddAttachmentsComponent {
    ...
    receiveFiles($event) {
        console.log($event);
        if ($event) {
            $event.forEach((f) => __awaiter(this, void 0, void 0, function* () {
                this.documentList.push(f);
            }));
...
ModalAddAttachmentsComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalAddAttachmentsComponent, selectors: [["modal-add-attachments"]], decls: 4, vars: 2, consts: [[1, "position-relative", "modal-attachments-content"], ["mat-dialog-close", "", 1, "close-dialog-icon", "close-dialog-icon-15", "bot-icon", 3, "click"], [3, "icon", "size"], [3, "files"]], template: function ModalAddAttachmentsComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(KonversoModule, { declarations: [KonversoComponent,
            DesktopFullScreenComponent,
            FirstVisitComponent,
            SafeHtmlPipe,
            CustomCheckboxCalendarComponent,
            ...
            ReactiveFormsModule,
            HttpClientModule,
            CommonModule, i4.NowboardIconModule, i2.NgxAttachmentModule], exports: [KonversoComponent,
            NowboardIconModule,
            NgxAttachmentModule] });
})();

...
function DesktopFullScreenComponent_ng_container_3_div_2_ng_container_8_ng_container_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("disabled", !ctx_r13.userInput || ctx_r13.inputType === "number");
    i0.ɵɵadvance(1);
